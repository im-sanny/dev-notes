...
for a function to be higher order function it must have one of the following rules in them: 1. take function as parameter 2. function return 3. both

### Functional Paradigm and Logic
